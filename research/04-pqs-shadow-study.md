...
這個想法很有足球直覺，所以我們做了 PQS shadow benchmark。但 shadow 的意思是「影子測試」：只觀察如果加上 PQS，xG 和勝平負機率會漂移多少，不宣稱它真的提升預測。
...
因此我們先不把 PQS 放進正式 Predictor，而是讓它成為 additive xG shadow layer，觀察它會把 baseline xG 推到哪裡。
