...
2026 年世界盃即將到來，因此 FIFA World Cup 2026 Predictor 4.0 開始成形，目標是建立一個能夠預測：
...
Predictor 4.0 開發到中後期時，一個問題變得越來越明顯。
...
因此另外建立了 Calibration Lab。

Calibration Lab 的目標不是增加新功能。

而是驗證現有功能。

Calibration Lab 希望回答：
